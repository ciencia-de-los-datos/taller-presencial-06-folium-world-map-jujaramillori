...
def clean_countries(affiliations):
    """Reemplaza los nombres de los paises por los nombres estandarizados en la libreria pycountry."""
...
def count_country_frequency(affiliations):
    ...
    countries = countries.explode() # Divide las listas en filas #"Esta es una de las vainas que no se le pueden olvidar a uno" Velazquez (2024)
